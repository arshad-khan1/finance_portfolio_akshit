      ...
      <div className="container mx-auto px-8 md:px-12 lg:px-16 z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-3/5 text-white">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold mb-4">Akshit Bakshi</h1>
            <h2 className="text-2xl md:text-3xl font-serif mb-6">
              <span className="text-accent">MBA Finance</span> Professional
            </h2>
            <p className="text-lg md:text-xl mb-8 max-w-2xl">
              Specialized in financial analysis, valuation, and investment banking with a proven track record of delivering strategic insights and value creation.
            </p>
            
            {/* Social Links */}
            <div className="flex gap-6 mb-8">
              <a href="https://linkedin.com/in/akshitbakshi" target="_blank" rel="noopener noreferrer" className="text-white hover:text-accent transition-colors">
                <Linkedin size={24} />
              </a>
              <a href="mailto:akshit.bakshi@example.com" className="text-white hover:text-accent transition-colors">
                <Mail size={24} />
              </a>
              <a href="tel:+1234567890" className="text-white hover:text-accent transition-colors">
                <Phone size={24} />
              </a>
              <a href="https://github.com/akshitbakshi" target="_blank" rel="noopener noreferrer" className="text-white hover:text-accent transition-colors">
                <Github size={24} />
              </a>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#contact">
                <Button 
                  className="bg-accent hover:bg-opacity-90 text-primary font-bold py-3 px-8 rounded-md shadow-lg transition duration-300 transform hover:scale-105"
                >
                  Contact Me
                </Button>
              </a>
