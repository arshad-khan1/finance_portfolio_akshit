      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-gray-400 hover:text-accent transition duration-300" aria-label="LinkedIn">
              <svg
            ...
            <a href="#" className="text-gray-400 hover:text-accent transition duration-300" aria-label="Twitter">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="currentColor"
            ...
            <a href="#" className="text-gray-400 hover:text-accent transition duration-300" aria-label="Email">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="currentColor"
            ...
            <a href="#" className="text-gray-400 hover:text-accent transition duration-300" aria-label="GitHub">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
                fill="currentColor"
